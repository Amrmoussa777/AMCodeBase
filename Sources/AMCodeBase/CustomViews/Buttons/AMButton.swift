...
open class AMButton: UIButton {
   ...
   public init(text:String,bGColor:UIColor,iconImage:UIImage? = Images.bagImage) {
...
open class AMLogOutButton:AMButton{
    
    public override init(text: String, bGColor: UIColor, iconImage: UIImage? = Images.bagImage) {
   ...
   private  func configureAsLogOut(){
