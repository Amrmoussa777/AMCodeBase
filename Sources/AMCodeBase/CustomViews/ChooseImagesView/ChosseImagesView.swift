...
class ChooseImagesView: UIView {
    ...
    let chooseButton = AMButton(text: "Choose Images", bGColor: .orange, iconImage: Images.plusImage)
    ...
    private func configure(){
        ...
        imagesCollectionView.register(AMImageSliderCell.self, forCellWithReuseIdentifier: AMImageSliderCell.cellID)
